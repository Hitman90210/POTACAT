...
// POTACAT local modification (see third_party/js8call/NOTES.md): the Qt
// Worker/Decoder thread wrapper needs moc and real Qt; the addon has its
// own driver. Nothing inside the decode path above is modified.
#ifndef JS8_NO_QT
/******************************************************************************/
// Worker
/******************************************************************************/
