...
const MESSAGES = Object.freeze({
  ...
  'js8-set-hback': { dir: Dir.C2S, feature: 'js8', fields: { enabled: f.optBool } },
  'js8-set-aprs-gate': { dir: Dir.C2S, feature: 'js8', fields: { enabled: f.optBool } },
  ...
  'js8-state': { dir: Dir.S2C, feature: 'js8', fields: { running: f.boolean, tx: f.optBoolean, txQueue: f.optInteger, submode: f.optString, heartbeat: f.optBoolean, heartbeatMin: f.optInteger, station: f.optObject, dialHz: f.optNumber, band: f.optString } },
