...
// JS8Call activity is commonly spread across the usable data-audio passband.
// Keep this wider than the old FT8-ish 500-2700 Hz window so edge stations
// visible on the waterfall are actually searched by the native decoder.
const JS8_DECODE_PASSBAND = Object.freeze({ lowHz: 200, highHz: 3200 });
...
class Js8Engine extends EventEmitter {
  ...
  _pushDecodeParams() {
    ...
    this._worker.postMessage({
      ...
      nfa: JS8_DECODE_PASSBAND.lowHz,
      nfb: JS8_DECODE_PASSBAND.highHz,
...
module.exports = { Js8Engine, SUBMODES, SAMPLE_RATE, JS8_DECODE_PASSBAND };
